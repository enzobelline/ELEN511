...
void init_inst()
{
  ...
  inst[0].num=1; inst[0].op=LD; inst[0].rd=6; inst[0].rs=12; inst[0].rt=32; // ld r6,32(r12)
  inst[1].num=2; inst[1].op=LD; inst[1].rd=2; inst[1].rs=13; inst[1].rt=44; // ld r2,44(r13)
  inst[2].num=3; inst[2].op=DIV; inst[2].rd=0; inst[2].rs=2; inst[2].rt=4; // div r0, r2, r4
  inst[3].num=4; inst[3].op=ADD; inst[3].rd=8; inst[3].rs=0; inst[3].rt=3; // add r8, r0, r3
  inst[4].num=5; inst[4].op=SUB; inst[4].rd=7; inst[4].rs=0; inst[4].rt=1; // sub r7, r0, r1
  inst[5].num=6; inst[5].op=MUL; inst[5].rd=9; inst[5].rs=7; inst[5].rt=6; // mul r9, r7, r6
  inst[6].num=7; inst[6].op=ST; inst[6].rd=8; inst[6].rs=8; inst[6].rt=0; // st r8,0(r8) 
